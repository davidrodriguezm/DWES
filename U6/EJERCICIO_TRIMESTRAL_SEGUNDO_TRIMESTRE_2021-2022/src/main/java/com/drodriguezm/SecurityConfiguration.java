...
import com.drodriguezm.services.JPAUserDetailsService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/profesores","/profesores/asignaturas").hasRole("USER")
		.antMatchers("/profesores","/profesores/asignaturas","/profesores/addProfesor","/profesores/addAsignatura").hasRole("ADMIN")
		.and()
		.formLogin();		
	}
